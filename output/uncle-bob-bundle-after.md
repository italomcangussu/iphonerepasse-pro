...
| Eixo | Status | Resumo |
|------|:------:|--------|
| Cobertura de testes | 🟡 | linhas 64.88% / ramos 52.1% (coverage/coverage-summary.json) |
| Teste de mutação | · | **não medido** — configure Stryker (JS) ou mutmut (Py) |
| Estrutura de dependências | 🔴 | 1 ciclo(s) de dependência; 263 arquivos com imports internos |
| Complexidade ciclomática | 🔴 | 325/1438 funções acima de 5 |
| Tamanho de módulos/funções | 🔴 | 89 arquivos > 200 linhas; 253 funções > 20 linhas |
| Duplicação | 🔴 | ~5.7% de blocos repetidos (heurístico) |

_Escopo: 426 arquivos-fonte, 1438 funções analisadas._
...
| `components/crm/ConversationsListPanel.tsx` | 54 | 31.57% | 🔴 |
| `pages/Calculator.tsx` | 47 | 34.7% | 🔴 |
| `pages/Settings.tsx` | 175 | 36.38% | 🔴 |
| `components/StockDetailsModal.tsx` | 97 | 39.26% | 🔴 |
| `pages/Warranties.tsx` | 115 | 42.17% | 🔴 |
| `components/AddSellerModal.tsx` | 26 | 43.9% | 🔴 |
| `pages/CRMChannels.tsx` | 102 | 44.24% | 🔴 |
| `services/storage.ts` | 8 | 45.45% | 🔴 |
| `components/crm/CRMSimpleCrud.tsx` | 71 | 45.6% | 🔴 |
| `components/crm/AudioMessage.tsx` | 54 | 47.31% | 🔴 |
| `pages/crm/ConversationsPage.tsx` | 467 | 48.9% | 🔴 |
| `pages/Debtors.tsx` | 100 | 49.79% | 🔴 |
| `pages/PayableDebts.tsx` | 127 | 50.4% | 🔴 |
| `components/AddCustomerModal.tsx` | 10 | 52.63% | 🔴 |
| `components/StockFormModal.tsx` | 220 | 54% | 🔴 |
| `pages/PDVHistory.tsx` | 125 | 56.43% | 🔴 |
| `services/dataContext.tsx` | 934 | 57.1% | 🔴 |
...
| `lib/crmRouting.ts` | 29.41% | 🔴 |
| `components/crm/ConversationsListPanel.tsx` | 31.57% | 🔴 |
| `pages/Calculator.tsx` | 34.7% | 🔴 |
| `lib/routePrefetch.ts` | 36.36% | 🔴 |
| `pages/Settings.tsx` | 36.38% | 🔴 |
| `lib/crm/messageUtils.ts` | 39.13% | 🔴 |
| `components/StockDetailsModal.tsx` | 39.26% | 🔴 |
| `pages/Warranties.tsx` | 42.17% | 🔴 |
| `components/AddSellerModal.tsx` | 43.9% | 🔴 |
| `pages/CRMChannels.tsx` | 44.24% | 🔴 |
| `services/storage.ts` | 45.45% | 🔴 |
| `components/crm/CRMSimpleCrud.tsx` | 45.6% | 🔴 |
