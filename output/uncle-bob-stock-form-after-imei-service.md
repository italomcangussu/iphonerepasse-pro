...
| Estrutura de dependências | 🟢 | 0 ciclo(s) de dependência; 55 arquivos com imports internos |
...
_Escopo: 56 arquivos-fonte, 164 funções analisadas._

## Funções mais complexas (complexidade > 5)

| Severidade | Função | Local | Complex. | Linhas | Args | Aninh. |
|:--:|--------|-------|:--:|:--:|:--:|:--:|
| 🔴 | `StockFormModal` | `StockFormModal.tsx:110` | **217** | 1604 | 1 | 5 |
...
|:--:|--------|-------|:--:|:--:|:--:|
| 🔴 | `StockFormModal` | `StockFormModal.tsx:110` | **1604** | 217 | 1 |
