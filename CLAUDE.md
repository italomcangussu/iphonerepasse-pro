...
- **Workflows:** the live workflow is `Cr4fPWe0prwS6XjI` ("ia repasse-pro v2 avancada"). The legacy `ia repasse-pro` workflow (`oWNdWPUq6kEFitsnl8OpH`) is no longer the operational reference. [scripts/n8n/export-repasse-workflow.mjs](scripts/n8n/export-repasse-workflow.mjs) exports the live v2 workflow to `output/n8n/ia-repasse-pro-v2-current.json`; see [docs/superpowers/specs/2026-06-12-n8n-repasse-v2-live-context.md](docs/superpowers/specs/2026-06-12-n8n-repasse-v2-live-context.md) for the current n8n context. n8n API base/key come from env (`N8N_*`) read by the scripts — never edit the deployed workflow blindly; export, patch, validate ([validate-repasse-next-workflow.mjs](scripts/n8n/validate-repasse-next-workflow.mjs)), then reactivate.
