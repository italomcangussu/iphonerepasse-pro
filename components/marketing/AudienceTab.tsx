 ...
 * tipo/modelo de aparelho comprado para ações comerciais. Comportamento inalterado;
 * apenas extraído de pages/Marketing.tsx para conviver com os novos submenus.
 */
